...
#line 28 ".\\..\\EmbSysLib\\Src\\MCU\\STM32L1xx\\MCU.h"
...
#line 32 ".\\..\\EmbSysLib\\Src\\MCU\\STM32L1xx\\MCU.h"
...
#line 50 ".\\..\\EmbSysLib\\Src\\MCU\\STM32L1xx\\MCU.h"
...
#line 70 ".\\..\\EmbSysLib\\Src\\MCU\\STM32L1xx\\MCU.h"
...
#line 71 ".\\..\\EmbSysLib\\Src\\MCU\\STM32L1xx\\MCU.h"
...
#line 75 ".\\..\\EmbSysLib\\Src\\MCU\\STM32L1xx\\MCU.h"
...
#line 76 ".\\..\\EmbSysLib\\Src\\MCU\\STM32L1xx\\MCU.h"
...
#line 5 "Src\\robo.h"
#line 1 "Src\\InduRoboter.h"
#line 14 "Src\\InduRoboter.h"
class InduRoboter{
	private:
		Achse &a0_;
		Achse &a1_;
...
cHwTimer_N  timerPWM ( cHwTimer_N::TIM_3, 16382  );
...
cDevDigital i3 (portC,3,cDevDigital::InPU,0);	
...
cDevDigital			motor1L(portB, 4, cDevDigital::Out,0);		
cDevDigital			motor1R(portB, 5, cDevDigital::Out,0);		
Motor m1(motor1L,motor1R);
cDevDigital			motor2L(portB, 0, cDevDigital::Out,0);		
cDevDigital			motor2R(portB, 1, cDevDigital::Out,0);		
Motor m2(motor2L,motor2R);
cDevDigital			motor3L(portB, 6, cDevDigital::Out,0);		
cDevDigital			motor3R(portB, 7, cDevDigital::Out,0);		
Motor m3(motor3L,motor3R);
cDevDigital			motor4L(portB, 8, cDevDigital::Out,0);		
cDevDigital			motor4R(portB, 9, cDevDigital::Out,0);		
...
#line 1 "Src\\RTOS_Task_Example.h"
...
cRTOS_RR<NUM_OF_RTOS_TASKS>  rtos( 1000  );
  ...
  while(1)
  {
    ...
    if( btnA.getEvent() == cDevDigital::ACTIVATED )
    {
      enable.toggle();
		...
		if( btnB.getEvent() == cDevDigital::ACTIVATED )		
    {
